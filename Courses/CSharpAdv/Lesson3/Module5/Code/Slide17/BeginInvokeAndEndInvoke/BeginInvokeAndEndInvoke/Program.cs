...
namespace APM
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Measure.It(delegate
            {
                Func<int> asyncCalculate1 = primeNumberCalculator.Calculate;
                IAsyncResult iar1 = asyncCalculate1.BeginInvoke(null, null);

                Func<int> asyncCalculate2 = primeNumberCalculator.Calculate;
                IAsyncResult iar2 = asyncCalculate2.BeginInvoke(null, null);
