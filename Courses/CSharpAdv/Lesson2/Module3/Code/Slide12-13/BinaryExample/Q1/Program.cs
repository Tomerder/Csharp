...
namespace BinaryExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            BinaryWriter writer = new BinaryWriter(new FileStream("matrix.txt", FileMode.Create));
            ...
            BinaryReader reader = new BinaryReader(new FileStream("matrix.txt", FileMode.Open));
