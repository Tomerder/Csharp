...
public static void main(String[] args) throws Exception
  {
    ...
    //System.gc();
	    ...
	    for (int rowIndex = 0; rowIndex < 5000; rowIndex++)
	    {		
	    	Runnable SumMulti = new SumMulti(rowIndex, atomicLong, matrix1[rowIndex], tempSum);
	    	executor2.execute(SumMulti);
	    	
	    } 
	    executor2.shutdown();
	    while(!executor2.isTerminated()){}	
	    Long endTimeSumMultiAtomic = System.currentTimeMillis();
	    System.out.println("Time Sum Multi: " + (endTimeSumMultiAtomic - startTimeSumMulti));
	    System.out.println("The Sum is : " + (atomicLong.longValue()));	  
	    System.out.println("-----------------------------------------");	
	    ...
	    float tempSumMulti = endTimeSumMultiAtomic - startTimeSumMulti;
